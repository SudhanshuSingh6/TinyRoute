...
const FEATURES = [
  {
    ...
    desc: "Create short, memorable links in seconds. Our intuitive interface makes URL shortening effortless — no technical knowledge required.",
    icon: <FaLink />,
  },
  {
    title: "Powerful Analytics",
    desc: "Gain insights into your link performance. Track clicks and date-based engagement to understand how your links are performing.",
    icon: <FaChartLine />,
  },
  {
    title: "Enhanced Security",
    desc: "All shortened URLs are protected with advanced encryption. Your data and your users' data remain safe and secure.",
    icon: <FaShieldAlt />,
  },
  {
    title: "Fast and Reliable",
    desc: "Lightning-fast redirects with high uptime. Your shortened URLs will always be available and responsive for your users.",
    icon: <FaBolt />,
  },
];
...
const StatCard = ({ value, label, green }) => (
  <div className="flex-1 bg-slate-50 rounded-lg p-3 text-center">
    <p
      className={`font-bold text-lg ${green ? "text-green-500" : "text-slate-800"}`}
    >
      {value}
    </p>
...
const LandingPage = () => {
  ...
  const handleManageLinks = () => navigate("/dashboard");

  const handleCreateLink = () => navigate("/register");
  ...
  return (
    <div className="min-h-page lg:px-14 sm:px-8 px-4 bg-white">
      ...
      <div className="lg:flex-row flex-col lg:py-16 pt-14 lg:gap-14 gap-10 flex justify-between items-center">
        <div className="flex-1">
          ...
          <p className="text-slate-500 text-base my-6 leading-relaxed lg:w-5/6">
            ...
            Track clicks, manage all your links in one place, and share with
            confidence.
          </p>
          <div className="flex items-center gap-3 flex-wrap">
            <Button variant="primary" size="lg" onClick={handleManageLinks}>
              Manage Links
            </Button>
            <Button variant="secondary" size="lg" onClick={handleCreateLink}>
              Create Short Link
            </Button>
          </div>
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl shadow-xl p-6 sm:w-card-md w-card-sm">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg px-3 py-2.5 flex items-center justify-between">
                <p className="text-blue-600 text-sm font-semibold">
                  url.tinyroute.com/xK9mP
                </p>
                <span className="text-xs bg-blue-500 text-white px-2 py-0.5 rounded-md font-medium">
                  Copy
                </span>
              </div>
      ...
      <div className="bg-custom-gradient rounded-2xl p-10 text-center text-white mb-16">
        <h2 className="font-bold font-montserrat text-3xl mb-3">
          Ready to shorten your first link?
        </h2>
        <p className="text-blue-100 mb-6 text-sm">
          Join thousands of users simplifying how they share links online.
        </p>
        <div className="flex justify-center">
          <Button
            ...
            className="bg-white text-btnColor hover:bg-slate-100 font-bold"
          >
